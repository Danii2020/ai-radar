...
> Last synced: 2026-09-17 by harny-sync (archive mode: 10 features archived,
> 7 capability docs created, index regenerated — see Notes)
...
| cursor / next_cursor pagination | feed-api |
...
None yet. All 10 features archived in this pass shipped before `harny-adr`
existed in this project; per that skill's own no-backfill guardrail, none
get retroactive ADRs. Future features archived from here forward will
register real rows here.
...
`specs/web-feed-ui/` (Phase 2 spec 02, the Next.js frontend) is still
genuinely in progress and was deliberately left untouched, not archived.
